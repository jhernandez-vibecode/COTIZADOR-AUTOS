 ...
 */
global.location = { origin: 'https://cotizador.appsegurosdigitales.com' };

var { acortarEnlace } = require('../js/shortlink.js');
...
(async function () {
  ...
  ok('g-devuelve',  r1 === 'https://cotizador.appsegurosdigitales.com/g/K7M4PQ2XRB');
  ...
  ok('a-devuelve',   r2 === 'https://cotizador.appsegurosdigitales.com/a/ABCDEFGH23');
